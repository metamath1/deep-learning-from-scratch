...
class SimpleConvNet:
    """CONV층이 2개인 합성곱 신경망
    구성은 아래와 같고 conv층은 책의 기본 클래스인 Convolution을 사용함
    ...
    def __init__(self, input_dim=(1, 28, 28), 
        ...
        self.layers['Conv1'] = Convolution(self.params['W1'], self.params['b1'], conv1_param['stride'], conv1_param['pad'])
        self.layers['Relu1'] = Relu()
        self.layers['Pool1'] = Pooling(pool_h=2, pool_w=2, stride=2)
        
        self.layers['Conv2'] = Convolution(self.params['W2'], self.params['b2'], conv2_param['stride'], conv2_param['pad'])
